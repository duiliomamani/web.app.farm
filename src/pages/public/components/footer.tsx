...
const Footer = () => {
    return <footer className="d-flex shadow-lg py-5 bg-white">
        <Container fluid>
            <Row className="text-center">
                ...
                <Col md={4}>
                    <p className="text-muted">© <Moment format="yyyy" date={Date.now()}></Moment> - FarmApp. Todos los derechos reservados</p>
                    <p className="text-muted">Desarrollado por CactusTechCode</p>
                </Col>
            </Row>
        </Container>
    </footer>
