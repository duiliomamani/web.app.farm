...
import { Button, Card, CardGroup, Container, ListGroup, NavDropdown, Navbar, Row, Table } from "react-bootstrap";
            ...
            <Row>
                <Navbar bg="white" expand="lg" className="shadow-lg p-3">
                    <Container fluid className="d-flex justify-content-end">
                        ...
                        <NavDropdown id="nav-profile" title={<><FontAwesomeIcon icon={["fas", "user"]} size="1x" /> <span>{auth?.user.name}</span></>} align="end">
                            <NavDropdown.Header className="py-3">Rol : {auth?.user.roles}</NavDropdown.Header>
